...
(when (eq system-type 'windows-nt)
  (setopt find-program (expand-file-name "~/Documents/Sync/PortableWindows/emacs/bin/find.exe")))
#+END_SRC
...
(use-package org
  ...
  (defun neo/org-rss-publish-to-rss (plist filename pub-dir)
  ...
  (setq org-publish-project-alist
        (list
         (list "org-content"
               ...
               :base-directory "~/Documents/Sync/Notes/website/content/"
               :base-extension "org"
         ...
         (list "org-static"
               :base-directory "~/Documents/Sync/Notes/website/static/"
         ...
         (list "org-blog"
           :base-directory "~/Documents/Sync/Notes/website/blog"
           :base-extension "org"
           :html-link-home "blog.neosloth.dev"
         ...
         (list "website" :components (list "org-content" "org-static" "org-blog")))))
#+END_SRC
...
(use-package org-roam
  :ensure t
  :custom
  (org-roam-directory (file-truename "~/Documents/Sync/Notes/roam"))
