...
#+END_SRC
** Projectile
Some package keeps pulling projectile in but I dont actually want to use it
#+BEGIN_SRC emacs-lisp
...
(use-package eglot
  ...
  :hook ((python-mode js2-mode) . eglot-ensure)
  :config
...
*** Validator 
#+BEGIN_SRC emacs-lisp
(defun html-nuchecker-hook ()
  (set (make-local-variable 'compile-command)
       (concat "java -jar " (expand-file-name "~/Sync/Misc/vnu.jar") " -Werror "
               (shell-quote-argument (buffer-file-name)))))

(add-hook 'mhtml-mode-hook 'html-nuchecker-hook)
